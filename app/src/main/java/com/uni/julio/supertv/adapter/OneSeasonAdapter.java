...
public class OneSeasonAdapter extends TVRecyclerViewAdapter<OneSeasonAdapter.MyViewHolder> implements ImageLoadedListener {
    ...
    public OneSeasonAdapter(Context context, TVRecyclerView recyclerView, List<?extends VideoStream> videoDataList, int rowPosition, MovieSelectedListener movieSelectedListener) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int position) {
        View itemView= LayoutInflater.from(mContext).inflate(R.layout.more_like_row,viewGroup,false);
