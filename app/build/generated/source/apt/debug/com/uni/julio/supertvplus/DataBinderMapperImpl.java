...
import com.uni.julio.supertvplus.databinding.ActivityAccountBindingImpl;
import com.uni.julio.supertvplus.databinding.ActivityAccountBindingLandImpl;
import com.uni.julio.supertvplus.databinding.ActivityLiveBindingImpl;
import com.uni.julio.supertvplus.databinding.ActivityLivetvnewBindingImpl;
import com.uni.julio.supertvplus.databinding.ActivityMainBindingImpl;
import com.uni.julio.supertvplus.databinding.ActivityMainBindingLandImpl;
import com.uni.julio.supertvplus.databinding.ActivityMorevideoBindingImpl;
import com.uni.julio.supertvplus.databinding.ActivityMoviesBindingImpl;
import com.uni.julio.supertvplus.databinding.ActivityMoviesBindingLargeImpl;
import com.uni.julio.supertvplus.databinding.ActivityMultiSeasonDetailBindingImpl;
import com.uni.julio.supertvplus.databinding.ActivityMultiSeasonDetailBindingLandImpl;
import com.uni.julio.supertvplus.databinding.ActivityOneseasonDetailBindingImpl;
import com.uni.julio.supertvplus.databinding.ActivityOneseasonDetailBindingLandImpl;
import com.uni.julio.supertvplus.databinding.ActivitySearchBindingImpl;
import com.uni.julio.supertvplus.databinding.ActivitySelectserverBindingImpl;
import com.uni.julio.supertvplus.databinding.GridviewRowBindingImpl;
import com.uni.julio.supertvplus.databinding.ItemServerBindingImpl;
import com.uni.julio.supertvplus.databinding.LiveCategoryListBindingImpl;
import com.uni.julio.supertvplus.databinding.LivetvnewListBindingImpl;
import com.uni.julio.supertvplus.databinding.MultiseasonRowBindingImpl;
import com.uni.julio.supertvplus.databinding.MultiseasonRowBindingLandImpl;
import com.uni.julio.supertvplus.databinding.VideoListRowBindingImpl;
import com.uni.julio.supertvplus.databinding.VideoListSectionBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.activity_account, LAYOUT_ACTIVITYACCOUNT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.activity_live, LAYOUT_ACTIVITYLIVE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.activity_livetvnew, LAYOUT_ACTIVITYLIVETVNEW);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.activity_main, LAYOUT_ACTIVITYMAIN);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.activity_morevideo, LAYOUT_ACTIVITYMOREVIDEO);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.activity_movies, LAYOUT_ACTIVITYMOVIES);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.activity_multi_season_detail, LAYOUT_ACTIVITYMULTISEASONDETAIL);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.activity_oneseason_detail, LAYOUT_ACTIVITYONESEASONDETAIL);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.activity_search, LAYOUT_ACTIVITYSEARCH);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.activity_selectserver, LAYOUT_ACTIVITYSELECTSERVER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.gridview_row, LAYOUT_GRIDVIEWROW);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.item_server, LAYOUT_ITEMSERVER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.live_category_list, LAYOUT_LIVECATEGORYLIST);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.livetvnew_list, LAYOUT_LIVETVNEWLIST);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.multiseason_row, LAYOUT_MULTISEASONROW);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.video_list_row, LAYOUT_VIDEOLISTROW);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.uni.julio.supertvplus.R.layout.video_list_section, LAYOUT_VIDEOLISTSECTION);
  }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      sKeys.put("layout-land/activity_account_0", com.uni.julio.supertvplus.R.layout.activity_account);
      sKeys.put("layout/activity_account_0", com.uni.julio.supertvplus.R.layout.activity_account);
      sKeys.put("layout/activity_live_0", com.uni.julio.supertvplus.R.layout.activity_live);
      sKeys.put("layout/activity_livetvnew_0", com.uni.julio.supertvplus.R.layout.activity_livetvnew);
      sKeys.put("layout/activity_main_0", com.uni.julio.supertvplus.R.layout.activity_main);
      sKeys.put("layout-land/activity_main_0", com.uni.julio.supertvplus.R.layout.activity_main);
      ...
      sKeys.put("layout/activity_selectserver_0", com.uni.julio.supertvplus.R.layout.activity_selectserver);
      sKeys.put("layout/gridview_row_0", com.uni.julio.supertvplus.R.layout.gridview_row);
      sKeys.put("layout/item_server_0", com.uni.julio.supertvplus.R.layout.item_server);
      sKeys.put("layout/live_category_list_0", com.uni.julio.supertvplus.R.layout.live_category_list);
      sKeys.put("layout/livetvnew_list_0", com.uni.julio.supertvplus.R.layout.livetvnew_list);
      sKeys.put("layout/multiseason_row_0", com.uni.julio.supertvplus.R.layout.multiseason_row);
      sKeys.put("layout-land/multiseason_row_0", com.uni.julio.supertvplus.R.layout.multiseason_row);
      sKeys.put("layout/video_list_row_0", com.uni.julio.supertvplus.R.layout.video_list_row);
      sKeys.put("layout/video_list_section_0", com.uni.julio.supertvplus.R.layout.video_list_section);
    }
  }
}
