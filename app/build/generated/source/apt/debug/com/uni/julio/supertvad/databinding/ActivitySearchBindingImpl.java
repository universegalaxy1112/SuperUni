...
public class ActivitySearchBindingImpl extends ActivitySearchBinding  {
    ...
    private ActivitySearchBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.uni.julio.supertvad.helper.TVRecyclerView) bindings[1]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.SearchFM == variableId) {
            setSearchFM((com.uni.julio.supertvad.viewmodel.SearchViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSearchFM(@Nullable com.uni.julio.supertvad.viewmodel.SearchViewModel SearchFM) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvad.viewmodel.SearchViewModel searchFM = mSearchFM;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            com.uni.julio.supertvad.binding.BindingAdapters.bindHiddenVisibility(this.progressBar, SearchFMIsLoading1);
            com.uni.julio.supertvad.binding.BindingAdapters.bindHiddenVisibility(this.searchRecycler, searchFMIsLoadingGet);
        }
    }
