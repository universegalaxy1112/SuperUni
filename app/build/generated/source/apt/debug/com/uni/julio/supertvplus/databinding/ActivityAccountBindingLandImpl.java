...
public class ActivityAccountBindingLandImpl extends ActivityAccountBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.accountDetailsVM == variableId) {
            setAccountDetailsVM((com.uni.julio.supertvplus.viewmodel.AccountDetailsViewModel) variable);
        }
        else if (BR.user == variableId) {
            setUser((com.uni.julio.supertvplus.model.User) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAccountDetailsVM(@Nullable com.uni.julio.supertvplus.viewmodel.AccountDetailsViewModel AccountDetailsVM) {
    ...
    public void setUser(@Nullable com.uni.julio.supertvplus.model.User User) {
        this.mUser = User;
        synchronized(this) {
            mDirtyFlags |= 0x4L;
        }
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvplus.viewmodel.AccountDetailsViewModel accountDetailsVM = mAccountDetailsVM;
        boolean accountDetailsVMIsLoading = false;
        com.uni.julio.supertvplus.model.User user = mUser;
        ...
        if ((dirtyFlags & 0xbL) != 0) {
            ...
            com.uni.julio.supertvplus.binding.BindingAdapters.bindHiddenVisibility(this.accountDetailsContent, accountDetailsVMIsLoadingGet);
            com.uni.julio.supertvplus.binding.BindingAdapters.bindHiddenVisibility(this.progressBar, accountDetailsVMIsLoading);
        }
        if ((dirtyFlags & 0xaL) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0xcL) != 0) {
            ...
            com.uni.julio.supertvplus.binding.BindingAdapters.setDate(this.mboundView4, userExpirationDate);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView5, userVersion);
        }
    }
    // Listener Stub Implementations
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvplus.viewmodel.AccountDetailsViewModel value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvplus.viewmodel.AccountDetailsViewModel value) {
            this.value = value;
