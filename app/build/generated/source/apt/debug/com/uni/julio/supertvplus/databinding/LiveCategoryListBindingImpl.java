...
public class LiveCategoryListBindingImpl extends LiveCategoryListBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.liveCategoryAdapter == variableId) {
            setLiveCategoryAdapter((com.uni.julio.supertvplus.adapter.LiveCategoryAdapter) variable);
        }
        else if (BR.liveCategory == variableId) {
            setLiveCategory((com.uni.julio.supertvplus.model.LiveTVCategory) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setLiveCategoryAdapter(@Nullable com.uni.julio.supertvplus.adapter.LiveCategoryAdapter LiveCategoryAdapter) {
    ...
    public void setLiveCategory(@Nullable com.uni.julio.supertvplus.model.LiveTVCategory LiveCategory) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvplus.adapter.LiveCategoryAdapter liveCategoryAdapter = mLiveCategoryAdapter;
        ...
        com.uni.julio.supertvplus.model.LiveTVCategory liveCategory = mLiveCategory;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvplus.adapter.LiveCategoryAdapter value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvplus.adapter.LiveCategoryAdapter value) {
            this.value = value;
