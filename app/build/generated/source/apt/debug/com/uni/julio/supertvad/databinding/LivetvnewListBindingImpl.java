...
public class LivetvnewListBindingImpl extends LivetvnewListBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.livetvAdapter == variableId) {
            setLivetvAdapter((com.uni.julio.supertvad.adapter.LivetvAdapterNew) variable);
        }
        else if (BR.liveProgramItem == variableId) {
            setLiveProgramItem((com.uni.julio.supertvad.model.LiveProgram) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setLivetvAdapter(@Nullable com.uni.julio.supertvad.adapter.LivetvAdapterNew LivetvAdapter) {
    ...
    public void setLiveProgramItem(@Nullable com.uni.julio.supertvad.model.LiveProgram LiveProgramItem) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvad.adapter.LivetvAdapterNew livetvAdapter = mLivetvAdapter;
        com.uni.julio.supertvad.model.LiveProgram liveProgramItem = mLiveProgramItem;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.adapter.LivetvAdapterNew value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvad.adapter.LivetvAdapterNew value) {
            this.value = value;
