...
public class ActivityLivetvnewBindingImpl extends ActivityLivetvnewBinding  {
    ...
    private ActivityLivetvnewBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.uni.julio.supertvad.helper.TVRecyclerView) bindings[11]
            , (android.widget.LinearLayout) bindings[8]
            , (de.hdodenhof.circleimageview.CircleImageView) bindings[1]
            , (android.widget.FrameLayout) bindings[0]
            , (android.widget.LinearLayout) bindings[6]
            , (com.uni.julio.supertvad.helper.TVRecyclerView) bindings[10]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.liveTVFragmentVM == variableId) {
            setLiveTVFragmentVM((com.uni.julio.supertvad.viewmodel.LiveTVViewModel) variable);
        }
        else if (BR.currentCategory == variableId) {
            setCurrentCategory((com.uni.julio.supertvad.model.LiveTVCategory) variable);
        }
        else if (BR.currentProgram == variableId) {
            setCurrentProgram((com.uni.julio.supertvad.model.LiveProgram) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setLiveTVFragmentVM(@Nullable com.uni.julio.supertvad.viewmodel.LiveTVViewModel LiveTVFragmentVM) {
    ...
    public void setCurrentCategory(@Nullable com.uni.julio.supertvad.model.LiveTVCategory CurrentCategory) {
    ...
    public void setCurrentProgram(@Nullable com.uni.julio.supertvad.model.LiveProgram CurrentProgram) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvad.viewmodel.LiveTVViewModel liveTVFragmentVM = mLiveTVFragmentVM;
        com.uni.julio.supertvad.model.LiveTVCategory currentCategory = mCurrentCategory;
        com.uni.julio.supertvad.model.LiveProgram currentProgram = mCurrentProgram;
        ...
        if ((dirtyFlags & 0xcL) != 0) {
            ...
            com.uni.julio.supertvad.binding.BindingAdapters.loadImage(this.markImg, currentProgramIconUrl);
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.LiveTVViewModel value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvad.viewmodel.LiveTVViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.LiveTVViewModel value;
        public OnClickListenerImpl1 setValue(com.uni.julio.supertvad.viewmodel.LiveTVViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
