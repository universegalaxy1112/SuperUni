...
public class ItemServerBindingImpl extends ItemServerBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.serverAdapter == variableId) {
            setServerAdapter((com.uni.julio.supertvplus.adapter.ServerAdapter) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setServerAdapter(@Nullable com.uni.julio.supertvplus.adapter.ServerAdapter ServerAdapter) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvplus.adapter.ServerAdapter serverAdapter = mServerAdapter;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvplus.adapter.ServerAdapter value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvplus.adapter.ServerAdapter value) {
            this.value = value;
