...
public class LiveCategoryListBindingImpl extends LiveCategoryListBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.liveCategoryAdapter == variableId) {
            setLiveCategoryAdapter((com.uni.julio.supertvad.adapter.LiveCategoryAdapter) variable);
        }
        else if (BR.liveCategory == variableId) {
            setLiveCategory((com.uni.julio.supertvad.model.LiveTVCategory) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setLiveCategoryAdapter(@Nullable com.uni.julio.supertvad.adapter.LiveCategoryAdapter LiveCategoryAdapter) {
    ...
    public void setLiveCategory(@Nullable com.uni.julio.supertvad.model.LiveTVCategory LiveCategory) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvad.adapter.LiveCategoryAdapter liveCategoryAdapter = mLiveCategoryAdapter;
        ...
        com.uni.julio.supertvad.model.LiveTVCategory liveCategory = mLiveCategory;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.adapter.LiveCategoryAdapter value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvad.adapter.LiveCategoryAdapter value) {
            this.value = value;
