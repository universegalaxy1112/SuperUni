...
public class MultiseasonRowBindingImpl extends MultiseasonRowBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.moviesAdapter == variableId) {
            setMoviesAdapter((com.uni.julio.supertvad.adapter.MultiSeasonAdapter) variable);
        }
        else if (BR.moviesMenuItem == variableId) {
            setMoviesMenuItem((com.uni.julio.supertvad.model.Episode) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMoviesAdapter(@Nullable com.uni.julio.supertvad.adapter.MultiSeasonAdapter MoviesAdapter) {
    ...
    public void setMoviesMenuItem(@Nullable com.uni.julio.supertvad.model.Episode MoviesMenuItem) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvad.adapter.MultiSeasonAdapter moviesAdapter = mMoviesAdapter;
        com.uni.julio.supertvad.model.Episode moviesMenuItem = mMoviesMenuItem;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            com.uni.julio.supertvad.binding.BindingAdapters.setTitleEpisode(this.detail, moviesMenuItemPosition);
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.adapter.MultiSeasonAdapter value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvad.adapter.MultiSeasonAdapter value) {
            this.value = value;
