...
public class VideoListSectionBindingImpl extends VideoListSectionBinding  {
    ...
    private VideoListSectionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.uni.julio.supertvad.helper.TVRecyclerView) bindings[7]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.categoryAdapter == variableId) {
            setCategoryAdapter((com.uni.julio.supertvad.adapter.MoviesCategoryAdapter) variable);
        }
        else if (BR.movieCategory == variableId) {
            setMovieCategory((com.uni.julio.supertvad.model.MovieCategory) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setCategoryAdapter(@Nullable com.uni.julio.supertvad.adapter.MoviesCategoryAdapter CategoryAdapter) {
    ...
    public void setMovieCategory(@Nullable com.uni.julio.supertvad.model.MovieCategory MovieCategory) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvad.adapter.MoviesCategoryAdapter categoryAdapter = mCategoryAdapter;
        com.uni.julio.supertvad.model.MovieCategory movieCategory = mMovieCategory;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.adapter.MoviesCategoryAdapter value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvad.adapter.MoviesCategoryAdapter value) {
            this.value = value;
