package com.uni.julio.supertvad.databinding;
import com.uni.julio.supertvad.R;
import com.uni.julio.supertvad.BR;
...
public class ActivityMultiSeasonDetailBindingLandImpl extends ActivityMultiSeasonDetailBinding  {
    ...
    private ActivityMultiSeasonDetailBindingLandImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 6
            ...
            , (com.uni.julio.supertvad.helper.TVRecyclerView) bindings[28]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.movieDetailItem == variableId) {
            setMovieDetailItem((com.uni.julio.supertvad.model.Movie) variable);
        }
        else if (BR.movieDetailsVM == variableId) {
            setMovieDetailsVM((com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMovieDetailItem(@Nullable com.uni.julio.supertvad.model.Movie MovieDetailItem) {
    ...
    public void setMovieDetailsVM(@Nullable com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel MovieDetailsVM) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvad.model.Movie movieDetailItem = mMovieDetailItem;
        ...
        com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel movieDetailsVM = mMovieDetailsVM;
        ...
        if ((dirtyFlags & 0x140L) != 0) {
            ...
            com.uni.julio.supertvad.binding.BindingAdapters.setActors(this.actorsDetail, movieDetailItemActors);
            com.uni.julio.supertvad.binding.BindingAdapters.setDescription(this.descriptionDetail, movieDetailItemDescription);
            com.uni.julio.supertvad.binding.BindingAdapters.setDirector(this.directorDetail, movieDetailItemDirector);
            com.uni.julio.supertvad.binding.BindingAdapters.visibleText(this.mboundView13, movieDetailItemGetReleaseDate);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView13, movieDetailItemGetReleaseDate);
            com.uni.julio.supertvad.binding.BindingAdapters.setDuration(this.mboundView15, movieDetailItemGetLength);
            com.uni.julio.supertvad.binding.BindingAdapters.bindShowHDIcon(this.mboundView16, movieDetailItemHDBranded);
            com.uni.julio.supertvad.binding.BindingAdapters.setRating(this.ratingBar, movieDetailItemStarRating);
        ...
        if ((dirtyFlags & 0x1a0L) != 0) {
            ...
            com.uni.julio.supertvad.binding.BindingAdapters.bindShowFavoriteIcon(this.imageView8, movieDetailsVMIsFavoriteGet);
        }
        if ((dirtyFlags & 0x190L) != 0) {
            // api target 1

            com.uni.julio.supertvad.binding.BindingAdapters.bindLikeButton(this.mboundView17, movieDetailsVMLikedGet);
        }
        if ((dirtyFlags & 0x181L) != 0) {
            // api target 1

            com.uni.julio.supertvad.binding.BindingAdapters.bindDislikeButton(this.mboundView18, movieDetailsVMDislikedGet);
        }
        if ((dirtyFlags & 0x182L) != 0) {
            // api target 1

            com.uni.julio.supertvad.binding.BindingAdapters.bindInvisibleVisibility(this.mboundView3, movieDetailsVMIsHDGet);
        }
        if ((dirtyFlags & 0x184L) != 0) {
            // api target 1

            com.uni.julio.supertvad.binding.BindingAdapters.bindInvisibleVisibility(this.mboundView5, movieDetailsVMIsSDGet);
        }
        if ((dirtyFlags & 0x188L) != 0) {
            // api target 1

            com.uni.julio.supertvad.binding.BindingAdapters.bindInvisibleVisibility(this.mboundView7, movieDetailsVMIsTrailerGet);
        }
    }
    // Listener Stub Implementations
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value;
        public OnClickListenerImpl1 setValue(com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl2 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value;
        public OnClickListenerImpl2 setValue(com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl3 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value;
        public OnClickListenerImpl3 setValue(com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl4 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value;
        public OnClickListenerImpl4 setValue(com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl5 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value;
        public OnClickListenerImpl5 setValue(com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl6 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value;
        public OnClickListenerImpl6 setValue(com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl7 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value;
        public OnClickListenerImpl7 setValue(com.uni.julio.supertvad.viewmodel.EpisodeDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
