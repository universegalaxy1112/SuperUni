...
public class VideoListRowBindingImpl extends VideoListRowBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.moviesAdapter == variableId) {
            setMoviesAdapter((com.uni.julio.supertvplus.adapter.MoviesRecyclerAdapter) variable);
        }
        else if (BR.moviesMenuItem == variableId) {
            setMoviesMenuItem((com.uni.julio.supertvplus.model.Movie) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMoviesAdapter(@Nullable com.uni.julio.supertvplus.adapter.MoviesRecyclerAdapter MoviesAdapter) {
    ...
    public void setMoviesMenuItem(@Nullable com.uni.julio.supertvplus.model.Movie MoviesMenuItem) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvplus.adapter.MoviesRecyclerAdapter moviesAdapter = mMoviesAdapter;
        java.lang.String moviesMenuItemHDPosterUrl = null;
        com.uni.julio.supertvplus.model.Movie moviesMenuItem = mMoviesMenuItem;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            com.uni.julio.supertvplus.binding.BindingAdapters.loadImage(this.img, moviesMenuItemHDPosterUrl);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.title, moviesMenuItemGetTitle);
        }
    }
    // Listener Stub Implementations
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvplus.adapter.MoviesRecyclerAdapter value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvplus.adapter.MoviesRecyclerAdapter value) {
            this.value = value;
