...
public class ActivityMoviesBindingLargeImpl extends ActivityMoviesBinding  {
    ...
    private ActivityMoviesBindingLargeImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.uni.julio.supertvad.helper.TVRecyclerView) bindings[5]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.moviesMenuFragmentVM == variableId) {
            setMoviesMenuFragmentVM((com.uni.julio.supertvad.viewmodel.MoviesMenuViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMoviesMenuFragmentVM(@Nullable com.uni.julio.supertvad.viewmodel.MoviesMenuViewModel MoviesMenuFragmentVM) {
