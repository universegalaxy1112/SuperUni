...
public class ActivityOneseasonDetailBindingLandImpl extends ActivityOneseasonDetailBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.movieDetailItem == variableId) {
            ...
            setMovieDetailsVM((com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMovieDetailsVM(@Nullable com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel MovieDetailsVM) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel movieDetailsVM = mMovieDetailsVM;
        ...
        if ((dirtyFlags & 0x140L) != 0) {
            ...
            com.uni.julio.supertvad.binding.BindingAdapters.loadImage(this.fondoUrl, movieDetailItemHDFondoUrl);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView14, movieDetailItemGetReleaseDate);
            com.uni.julio.supertvad.binding.BindingAdapters.setDuration(this.mboundView16, movieDetailItemGetLength);
            com.uni.julio.supertvad.binding.BindingAdapters.bindShowHDIcon(this.mboundView17, movieDetailItemIsHDBranded);
        ...
        if ((dirtyFlags & 0x190L) != 0) {
            ...
            com.uni.julio.supertvad.binding.BindingAdapters.bindLikeButton(this.mboundView18, movieDetailsVMLikedGet);
        }
        if ((dirtyFlags & 0x181L) != 0) {
            // api target 1

            com.uni.julio.supertvad.binding.BindingAdapters.bindDislikeButton(this.mboundView19, movieDetailsVMDislikedGet);
        }
        if ((dirtyFlags & 0x182L) != 0) {
            // api target 1

            com.uni.julio.supertvad.binding.BindingAdapters.bindInvisibleVisibility(this.mboundView4, movieDetailsVMIsHDGet);
        }
        if ((dirtyFlags & 0x184L) != 0) {
            // api target 1

            com.uni.julio.supertvad.binding.BindingAdapters.bindInvisibleVisibility(this.mboundView6, movieDetailsVMIsSDGet);
        }
        if ((dirtyFlags & 0x188L) != 0) {
            // api target 1

            com.uni.julio.supertvad.binding.BindingAdapters.bindInvisibleVisibility(this.mboundView8, movieDetailsVMIsTrailerGet);
        }
    }
    // Listener Stub Implementations
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value;
        public OnClickListenerImpl1 setValue(com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl2 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value;
        public OnClickListenerImpl2 setValue(com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl3 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value;
        public OnClickListenerImpl3 setValue(com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl4 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value;
        public OnClickListenerImpl4 setValue(com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl5 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value;
        public OnClickListenerImpl5 setValue(com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl6 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value;
        public OnClickListenerImpl6 setValue(com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl7 implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value;
        public OnClickListenerImpl7 setValue(com.uni.julio.supertvad.viewmodel.MovieDetailsViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
