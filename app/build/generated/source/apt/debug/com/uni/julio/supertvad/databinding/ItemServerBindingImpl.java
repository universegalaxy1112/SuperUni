...
public class ItemServerBindingImpl extends ItemServerBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.serverAdapter == variableId) {
            setServerAdapter((com.uni.julio.supertvad.adapter.ServerAdapter) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setServerAdapter(@Nullable com.uni.julio.supertvad.adapter.ServerAdapter ServerAdapter) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvad.adapter.ServerAdapter serverAdapter = mServerAdapter;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvad.adapter.ServerAdapter value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvad.adapter.ServerAdapter value) {
            this.value = value;
