...
public class ActivitySearchBindingImpl extends ActivitySearchBinding  {
    ...
    private ActivitySearchBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.uni.julio.supertvplus.helper.TVRecyclerView) bindings[1]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.SearchFM == variableId) {
            setSearchFM((com.uni.julio.supertvplus.viewmodel.SearchViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSearchFM(@Nullable com.uni.julio.supertvplus.viewmodel.SearchViewModel SearchFM) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvplus.viewmodel.SearchViewModel searchFM = mSearchFM;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            com.uni.julio.supertvplus.binding.BindingAdapters.bindHiddenVisibility(this.progressBar, SearchFMIsLoading1);
            com.uni.julio.supertvplus.binding.BindingAdapters.bindHiddenVisibility(this.searchRecycler, searchFMIsLoadingGet);
        }
    }
