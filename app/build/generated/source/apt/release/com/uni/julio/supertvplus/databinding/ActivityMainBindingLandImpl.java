...
public class ActivityMainBindingLandImpl extends ActivityMainBinding  {
    ...
    private ActivityMainBindingLandImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.uni.julio.supertvplus.helper.TVRecyclerView) bindings[4]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.activityMainBindingVM == variableId) {
            setActivityMainBindingVM((com.uni.julio.supertvplus.viewmodel.MainCategoriesMenuViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivityMainBindingVM(@Nullable com.uni.julio.supertvplus.viewmodel.MainCategoriesMenuViewModel ActivityMainBindingVM) {
