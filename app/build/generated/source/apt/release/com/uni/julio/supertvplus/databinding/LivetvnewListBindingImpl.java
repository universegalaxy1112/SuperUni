...
public class LivetvnewListBindingImpl extends LivetvnewListBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.livetvAdapter == variableId) {
            setLivetvAdapter((com.uni.julio.supertvplus.adapter.LivetvAdapterNew) variable);
        }
        else if (BR.liveProgramItem == variableId) {
            setLiveProgramItem((com.uni.julio.supertvplus.model.LiveProgram) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setLivetvAdapter(@Nullable com.uni.julio.supertvplus.adapter.LivetvAdapterNew LivetvAdapter) {
    ...
    public void setLiveProgramItem(@Nullable com.uni.julio.supertvplus.model.LiveProgram LiveProgramItem) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertvplus.adapter.LivetvAdapterNew livetvAdapter = mLivetvAdapter;
        com.uni.julio.supertvplus.model.LiveProgram liveProgramItem = mLiveProgramItem;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertvplus.adapter.LivetvAdapterNew value;
        public OnClickListenerImpl setValue(com.uni.julio.supertvplus.adapter.LivetvAdapterNew value) {
            this.value = value;
