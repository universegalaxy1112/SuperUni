...
public class ActivityMoviesBindingImpl extends ActivityMoviesBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.moviesMenuFragmentVM == variableId) {
            setMoviesMenuFragmentVM((com.uni.julio.supertvplus.viewmodel.MoviesMenuViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMoviesMenuFragmentVM(@Nullable com.uni.julio.supertvplus.viewmodel.MoviesMenuViewModel MoviesMenuFragmentVM) {
