...
public abstract class ActivityMultiSeasonDetailBinding extends ViewDataBinding {
  ...
  protected ActivityMultiSeasonDetailBinding(Object _bindingComponent, View _root,
      int _localFieldCount, TextView actors, TextView actorsDetail, AdView adView,
      TextView description, TextView descriptionDetail, TabLayout detailTab, TextView director,
      TextView directorDetail, TextView dislike, ImageView fondoUrl, ImageView imageView7,
      ImageView imageView8, TextView like, LinearLayout play, RatingBar ratingBar,
      TVRecyclerView recyclerView, ScrollView scrollview, TextView textView5) {
  ...
  public static ActivityMultiSeasonDetailBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return ViewDataBinding.<ActivityMultiSeasonDetailBinding>inflateInternal(inflater, com.uni.julio.supertvplus.R.layout.activity_multi_season_detail, root, attachToRoot, component);
  }
  ...
  public static ActivityMultiSeasonDetailBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return ViewDataBinding.<ActivityMultiSeasonDetailBinding>inflateInternal(inflater, com.uni.julio.supertvplus.R.layout.activity_multi_season_detail, null, false, component);
  }
  ...
  public static ActivityMultiSeasonDetailBinding bind(@NonNull View view,
      @Nullable Object component) {
    return (ActivityMultiSeasonDetailBinding)bind(component, view, com.uni.julio.supertvplus.R.layout.activity_multi_season_detail);
  }
}
