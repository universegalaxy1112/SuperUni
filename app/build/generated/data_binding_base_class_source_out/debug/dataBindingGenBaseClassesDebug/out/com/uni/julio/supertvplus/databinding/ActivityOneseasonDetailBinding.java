...
public abstract class ActivityOneseasonDetailBinding extends ViewDataBinding {
  ...
  protected ActivityOneseasonDetailBinding(Object _bindingComponent, View _root,
      ...
      AppBarLayout appBarLayout, TextView description, TextView descriptionDetail,
      TextView director, TextView directorDetail, TextView dislike, ImageView fondoUrl,
      ImageView imageView7, ImageView imageView8, TextView like, LinearLayout play,
      RatingBar ratingBar, NestedScrollView scroll, TextView textView5) {
  ...
  public static ActivityOneseasonDetailBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return ViewDataBinding.<ActivityOneseasonDetailBinding>inflateInternal(inflater, com.uni.julio.supertvplus.R.layout.activity_oneseason_detail, root, attachToRoot, component);
  }
  ...
  public static ActivityOneseasonDetailBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return ViewDataBinding.<ActivityOneseasonDetailBinding>inflateInternal(inflater, com.uni.julio.supertvplus.R.layout.activity_oneseason_detail, null, false, component);
  }
  ...
  public static ActivityOneseasonDetailBinding bind(@NonNull View view,
      @Nullable Object component) {
    return (ActivityOneseasonDetailBinding)bind(component, view, com.uni.julio.supertvplus.R.layout.activity_oneseason_detail);
  }
}
