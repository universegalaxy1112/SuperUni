...
public class GridviewRowBindingImpl extends GridviewRowBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.moviesAdapter == variableId) {
            setMoviesAdapter((com.uni.julio.supertv.adapter.GridViewAdapter) variable);
        }
    ...
    public void setMoviesAdapter(@Nullable com.uni.julio.supertv.adapter.GridViewAdapter MoviesAdapter) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.supertv.adapter.GridViewAdapter moviesAdapter = mMoviesAdapter;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.supertv.adapter.GridViewAdapter value;
        public OnClickListenerImpl setValue(com.uni.julio.supertv.adapter.GridViewAdapter value) {
            this.value = value;
