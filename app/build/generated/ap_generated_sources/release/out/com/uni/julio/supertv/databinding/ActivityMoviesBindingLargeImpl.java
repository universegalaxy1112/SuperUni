...
public class ActivityMoviesBindingLargeImpl extends ActivityMoviesBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.moviesMenuFragmentVM == variableId) {
            setMoviesMenuFragmentVM((com.uni.julio.supertv.viewmodel.MoviesMenuViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMoviesMenuFragmentVM(@Nullable com.uni.julio.supertv.viewmodel.MoviesMenuViewModel MoviesMenuFragmentVM) {
